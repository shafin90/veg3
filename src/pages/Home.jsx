...
const GradientButton = ({ to, children, primary = false }) => (
  <Link to={to}>
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={`relative group overflow-hidden ${primary
    ...
    <div ref={containerRef} className="relative bg-secondary-900">
      ...
      >
        ...
        >
          ...
          >
            Sebastian's
            <br />
            <span className="text-primary-400">Kebap</span>
          </motion.h1>
          <motion.p
      ...
      <div className="relative">
        ...
        <section className="relative py-64 min-h-screen">
          <div className="absolute inset-0  bg-fixed bg-center opacity-5" />
                      ...
                      <div className="p-8 lg:p-10 flex flex-col flex-grow">
                        ...
                        <div className="flex justify-between items-center mt-auto">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <span className="text-base text-gray-500">{dish.time}</span>
                          </div>
                        </div>
                      </div>
                    </div>
